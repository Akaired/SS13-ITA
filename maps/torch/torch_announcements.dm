/datum/map/torch
	...
	emergency_shuttle_recall_message = "Attenzione a tutto il personale: protocollo di evacuazione annullato. Riprendere le normali attività."

	command_report_sound = sound('sound/AI/torch/commandreport.ogg', volume = 45)

	grid_check_message = "Attività anormale rilevata nella rete elettrica di %STATION_NAME%. Come precauzione, interromperemo la fornitura elettrica a %STATION_NAME% per una durata indefinita."
	...
	radiation_detected_message = "Livelli critici di radiazioni individuati nelle prossimità di %STATION_NAME%. Perfavore, evacuate nei tunnel di manutenzione schermati."
	...
	unknown_biological_entities_message = "Entità biologiche sconosciute individuate all'esterno di %STATION_NAME%, per favore, attendete aggiornamenti."
