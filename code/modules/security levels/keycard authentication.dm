/obj/machinery/keycard_auth
	name = "Dispositivo di Autenticazione per le Keycard"
	desc = "Questo dispositivo viene utilizzato per attivare le funzioni che richiedono piu di una carta d'identita per l'autenticazione."
